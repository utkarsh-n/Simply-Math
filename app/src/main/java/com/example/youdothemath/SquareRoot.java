...
public class SquareRoot extends Activity implements OnClickListener {
    ...
    private void chooseQuestion(){
        ...
        switch(operator){
            case ADD_OPERATOR:
                answer = Math.sqrt(operand1*operand1);
                break;
            default:
                break;
        }
        ...
        //show question
        question.setText(operators[operator] +""+operand1*operand1);
    }
